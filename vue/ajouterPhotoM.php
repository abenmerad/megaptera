...
$(document).ready(function() {
	...
	$('#lstlong').hide(); // on cache le champ par défaut
	$('#lstlat').hide(); // on cache le champ par défaut
...
<form enctype="multipart/form-data" method="post" action="index.php?uc=controleur&action=ajout">
		...
		<label for = "lieu">Latitude</label>
        <input type="text" id="lat" name="lat"/> 
		<p>
		<center>
        <SELECT id="lstlong" name = "lstlong">
		...
		<label for = "lieu">Longitude</label>
		...
		<input for = "anne" name = "anne" id="datepicker">
		</p>
        </div>
